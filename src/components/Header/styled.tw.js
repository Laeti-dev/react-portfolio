...
export const Nav = styled.nav.attrs({
  className: "w-full grid grid-cols-5 gap-4 justify-around justify-items-center items-center bg-nav-bar-color h-14 text-background-color fixed font-Inconsolata"
})``;
